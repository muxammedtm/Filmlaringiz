...
# SOZLAMALAR
# ========================
BOT_TOKEN = "8621461817:AAHT3HBWe7ljJ64uDE13U1eDPVjmdiw1hVg"
ADMIN_IDS = [123456789]  # /myid buyrug'i bilan o'zingizning ID ni yozing
CHANNEL_ID = "-1004241881660"
...
async def myid(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Bu ID ni bot.py dagi ADMIN_IDS ga yozing!"
    )
...
async def add_movie(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not is_admin(update.effective_user.id):
        await update.message.reply_text(
            ...
            "/myid buyrug'i bilan ID ni bilib,\n"
            "bot.py dagi ADMIN_IDS ga yozing!"
        )
        return
